...
export default async function AdminQRPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-bone flex flex-col items-center justify-center p-8">
            <div className="bg-white p-12 shadow-sm border border-black/10 flex flex-col items-center text-center max-w-sm w-full" id="qr-container">
                {/* Gallery Branding */}
                <div className="mb-8 space-y-2">
                    <h1 className="font-serif text-3xl tracking-widest uppercase text-soft-black">Shakya</h1>
                    <p className="font-sans text-[8px] tracking-[0.4em] uppercase text-frame-gold">Fine Art Gallery</p>
                </div>
                ...
                <div className="space-y-4 mb-8 w-full px-4">
                    <h2 className="font-serif text-2xl text-soft-black leading-tight">{art.title}</h2>
                    <div className="w-8 h-[1px] bg-frame-gold mx-auto" />
                    <p className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase">{art.artist}</p>
                </div>
