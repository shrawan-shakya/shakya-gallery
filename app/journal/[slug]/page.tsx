  ...
  return {
    ...
    openGraph: {
      ...
      images: article.mainImage?.asset
        ? [urlForImage(article.mainImage).url()]
        : [],
      type: "article",
    ...
    <article className="min-h-screen bg-bone pt-32 pb-24">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center mb-16">
        <div className="flex flex-wrap items-baseline justify-center gap-4 mb-8">
          <Link
            href="/journal"
            className="font-sans text-[10px] tracking-[0.2em] uppercase text-gray-400 hover:text-soft-black transition-colors"
          >
            The Journal
          </Link>
      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="mt-20 pt-12 border-t border-black/10 flex justify-between items-center">
          <Link
            href="/journal"
            className="font-sans text-xs tracking-[0.2em] uppercase text-soft-black hover:opacity-60 transition-opacity"
          >
            ← Back to Journal
          </Link>
        </div>
