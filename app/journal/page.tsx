    ...
    <main className="min-h-screen bg-bone pt-32 pb-20">
      ...
      <div className="t-container text-center mb-20 px-6">
        ...
        <p className="font-serif text-xl italic text-gray-500 max-w-2xl mx-auto">
          "A dedicated space for the art of collecting, storytelling, and
          appreciation."
        </p>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        {articles.length === 0 && (
          <div className="py-20 text-center border-y border-black/5 mb-20">
            <p className="font-sans text-sm text-gray-500 tracking-wide">
              Our primary journal entries are being curated. Scroll down to see
        ...
        {featured && (
          <div className="mb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <Link
              ...
              className="block relative aspect-[16/9] lg:aspect-[4/3] w-full overflow-hidden group"
            >
              {featured.imageUrl ? (
                <Image
        ...
        <div className="space-y-24 mt-24">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-serif text-3xl text-soft-black mb-6 italic">
              The Collector&apos;s Roadmap
            </h2>
            <p className="font-sans text-sm text-gray-500 leading-relaxed tracking-wide">
              We are currently preparing a series of expert insights designed
              for international and local collectors. These upcoming guides will
              cover everything from acquisition strategies to the preservation
              of Himalayan masterworks.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              {
                title:
                  "A Collector's Guide: How to Buy Original Art in Kathmandu",
                excerpt:
                  "Navigating the local art scene and identifying authentic masterpieces in the heart of the valley.",
                category: "Guide",
              },
              {
                title:
                  "The Investment Potential of Contemporary Nepali Paintings",
                excerpt:
                  "Why modern Himalayan fine art is becoming a staple for discerning global collectors.",
                category: "Market Insights",
              },
              {
                title: "Authenticity & Provenance in the Himalayan Art Market",
                excerpt:
                  "The importance of certification and the legacy of the Shakya Gallery promise.",
                category: "Advice",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="flex flex-col gap-6 opacity-60 group hover:opacity-100 transition-opacity duration-500"
              >
                <div className="aspect-[4/3] bg-black/[0.03] border border-black/5 flex items-center justify-center relative overflow-hidden">
                  <span className="font-sans text-[10px] tracking-[0.3em] uppercase text-gray-300">
                    Coming Soon
                  </span>
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="font-serif text-2xl text-soft-black leading-tight">
                    {item.title}
                  </h3>
          ...
          <div className="bg-soft-black p-12 text-center space-y-8 mb-20">
            ...
            <p className="font-sans text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
              Join our Collector&apos;s Circle to receive these guides directly
