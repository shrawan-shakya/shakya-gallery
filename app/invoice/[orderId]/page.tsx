...
export default async function InvoicePage({
  ...
  const isPaid =
    order.status === "paid_shipped" || order.status === "payment_processing";
    ...
    <div className="min-h-screen bg-bone pt-32 pb-40">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <Link
            href="/"
            className="font-serif tracking-[0.3em] font-light text-2xl text-soft-black block mb-12"
          >
            SHAKYA
          </Link>
          <h1 className="font-serif text-3xl md:text-5xl text-soft-black mb-4">
            Secure Invoice
          </h1>
        ...
        <div className="bg-white shadow-xl shadow-black/5 border border-black/5 flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-5/12 bg-gray-50/50 p-8 md:p-12 border-b md:border-b-0 md:border-r border-black/5">
              ...
              {order.artworks?.map((art: any, i: number) => (
                <div key={i} className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center">
                    <h3 className="font-serif text-base text-soft-black leading-tight">
                      {art.title}
                    </h3>
            ...
            <div className="mt-12 space-y-2">
              <h4 className="font-sans text-[10px] tracking-widest uppercase text-gray-400">
                Shipping To
              </h4>
            ...
            {isPaid ? (
              <div className="text-center py-12">
                ...
                <p className="font-sans text-gray-500 leading-relaxed max-w-sm mx-auto">
                  Thank you for your acquisition. We are currently preparing
                  your art for secure transport. You will receive tracking
              ...
              <>
                <div className="mb-10">
                  <h2 className="font-serif text-2xl text-soft-black mb-4">
                    Transfer Instructions
                  </h2>
                  <p className="font-sans text-sm text-gray-500 leading-relaxed">
                    To complete your acquisition, please initiate a secure bank
                    transfer or use Wise to send the exact total of{" "}
                    <strong>
                      {order.currency} {order.total?.toLocaleString()}
                    </strong>{" "}
                    to the gallery account details below.
                  </p>
                </div>
                ...
                <div className="bg-bone p-6 border border-black/5 space-y-4 mb-10">
                  <div className="flex justify-between items-center pb-4 border-b border-black/5">
                    ...
                    <span className="font-sans text-sm text-soft-black select-all">
                      Shrawan Shakya
                    </span>
                  </div>
                  {order.currency === "USD" ? (
                    <>
                      ...
                      <div className="flex justify-between items-center pt-2">
                        ...
                        <span className="font-sans text-sm text-soft-black">
                          Checking
                        </span>
                      </div>
                    </>
                    ...
                    <div className="text-center py-4">
                      <p className="font-sans text-xs text-gray-500">
                        Please contact the gallery for {order.currency} specific
                        transfer details.
                      </p>
                    </div>
                  )}
                ...
                <form
                  action={async () => {
                    ...
                    console.log(
                      "Client clicked transfer complete for order",
                      order._id,
                    );
                  }}
                >
                  <button
                    type="submit"
                    className="w-full bg-soft-black hover:bg-black text-white py-4 font-sans text-[11px] tracking-[0.2em] uppercase transition-colors"
                  >
                    I have transferred the funds
                  </button>
                  <p className="font-sans text-[10px] text-gray-400 text-center mt-4">
                    Clicking this will notify our curators to verify the
                    transfer.
                  </p>
                </form>
              </>
