        ...
        <div className="max-w-4xl mx-auto space-y-20">
          <Step
            ...
            text={
              <div className="space-y-4">
                <p>
                  Begin by exploring our digital collection. Every painting
                  shows its size, artist, year and{" "}
                  <span className="text-black font-semibold">
                    “Price on request – starts at $XXX”
                  </span>{" "}
                  (e.g. starts at $240).
                </p>
                <p>
                  This means you immediately know the lowest possible price.
                  Because each piece is unique, we confirm the exact final price
                  in your personal quote.
                </p>
                <p>
                  When a piece speaks to you — whether an expressive abstract or
                  a serene landscape — read its story. Art is personal; trust
                  your instinct.
                </p>
                <Link
                  href="/guide/choosing-art"
                  className="inline-block underline font-semibold hover:opacity-70 transition-opacity mt-2"
                >
          ...
          <Step
            ...
            text={
              <div className="space-y-4">
                <p>
                  As you find pieces that resonate, click{" "}
                  <span className="text-black font-semibold">
                    “Add to Inquiry Selection”
                  </span>
                  . You can curate multiple artworks into your personal gallery
                  cart.
                </p>
                <p>
                  When you are ready, review your selection in the side drawer
                  and submit a single, comprehensive inquiry in under 20
                  seconds.
                </p>
                <p>
                  Our curation team will review your complete selection and
                  reply within 24 hours (often the same day) with
                  high-resolution details, exact pricing, and a personalized,
          ...
          <Step
            ...
            text={
              <div className="space-y-6">
                <p>
                  Once you decide to proceed, we issue a simple, secure invoice.
                  Upon payment, the artwork is marked{" "}
                  <span className="italic">“Sold”</span> and reserved for you.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                  <div className="bg-bone/40 p-6 border border-black/10">
                    <h4 className="font-serif text-lg text-black mb-4">
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong className="font-semibold">Wise</strong>{" "}
                          (Recommended — fast, low fees)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-900">•</span>
                ...
                <p className="text-sm italic text-black">
                  We send clear instructions + screenshots with every quote.
                  Most buyers complete payment within 48 hours.
                </p>
              </div>
            }
          />
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  <p className="text-black">
                    Paintings are carefully packed (rolled in protective tubes
                    or fully crated). We handle all export paperwork and provide
                    the{" "}
                    <span className="italic font-medium text-black">
                      non-antiquity certificate
                    </span>
                    .
                  </p>
                  <p className="text-black">
                    If you prefer your artwork to arrive pre-framed, our
                    curators can arrange custom museum-grade framing for an
                    additional fee.
                  </p>
                </div>
              </div>
      ...
      <section className="py-24 px-6 md:px-12 bg-bone">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32">
          <div className="space-y-8">
            <div>
              <h2 className="font-serif text-3xl text-black mb-6">
                Authenticity Guaranteed
              </h2>
              <p className="font-sans text-sm md:text-base text-black leading-relaxed mb-6">
                Every artwork from SHAKYA Gallery is an original creation. We
                work directly with Nepal’s most established fine artists to
                ensure absolute provenance.
              </p>
              <p className="font-sans text-sm md:text-base text-black leading-relaxed">
                Included with every acquisition is a signed{" "}
                <strong className="text-black">
                  Certificate of Authenticity
                </strong>
                , detailing the artist, medium, year, and value — essential for
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="font-sans text-sm md:text-base text-black leading-relaxed mb-8">
                Unsure where to start? Our curators offer complimentary advisory
                services to help you build a cohesive collection that fits your
                space and budget.
              </p>
              <div className="space-y-6">
                <Button
