  ...
  if (items.length === 0 && !isSuccess) {
    return (
      <div className="min-h-screen bg-bone pt-40 pb-20 px-6 flex flex-col items-center justify-center text-center">
        <h1 className="font-serif text-3xl md:text-5xl text-soft-black mb-6">
          Your Selection is Empty
        </h1>
        <p className="font-sans text-gray-500 mb-8 max-w-md">
          Browse our collection to add pristine Nepalese art to your inquiry
          selection.
        </p>
        <Link
          href="/collection"
          className="font-sans text-xs tracking-[0.2em] uppercase text-soft-black border-b border-black pb-1 hover:text-black/60 transition-colors"
        >
    ...
    return (
      <div className="min-h-screen bg-bone pt-40 pb-20 px-6 flex flex-col items-center justify-center text-center">
        ...
        <p className="font-sans text-sm leading-loose text-soft-black max-w-lg mx-auto mb-12">
          Thank you for choosing Shakya Gallery. Our curators are reviewing your
          selection of masterworks. We are currently calculating custom shipping
          quotes to your address and will send a secured manual invoice via
    ...
    <div className="min-h-screen bg-bone pt-32 lg:pt-40 pb-40">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-7 lg:order-1 order-2">
          <h1 className="font-serif text-3xl md:text-4xl text-soft-black mb-2">
            Request to Purchase
          </h1>
          <p className="font-sans text-sm text-gray-500 mb-10">
            Submit your details below. You will receive a secure invoice
            containing exact shipping costs and bank transfer details within 24
            hours.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-4">
                <div className="relative w-1/3">
                  ...
                  <span className="absolute right-0 top-1/2 -translate-y-1/2 text-[10px] text-gray-400 pointer-events-none">
                    ▼
                  </span>
                </div>
                <Input
            ...
            <div className="space-y-4 pt-4">
              <h3 className="font-serif text-lg text-soft-black border-b border-black/5 pb-2 mb-4">
            ...
            <div className="space-y-1 pt-4">
              <label className="font-serif italic text-xs text-gray-500">
                ...
                <span className="font-sans ml-1 text-[10px] text-gray-400 opacity-70">
                  (Optional)
                </span>
              </label>
              <textarea
        ...
        <div className="lg:col-span-5 lg:order-2 order-1">
          <div className="bg-white p-6 md:p-8 shadow-sm border border-black/5 sticky top-24">
            <h2 className="font-sans text-[11px] tracking-[0.2em] uppercase text-gray-500 mb-6 border-b border-black/5 pb-4">
              Inquiry Summary
            </h2>
              ...
              {items.map((item, idx) => (
                <div key={item._id || `item-${idx}`} className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center">
                    <h3 className="font-serif text-lg leading-tight text-soft-black">
                      {item.title}
                    </h3>
                    ...
                    <div className="font-sans text-xs mt-2 text-soft-black">
                      {item.showPrice && item.price ? (
                        ...
                        <span className="italic font-serif">
                          Starts at ${item.startingPrice.toLocaleString()}
                        </span>
                      ) : (
                        <span className="italic font-serif">
                          Price on Request
            ...
            <div className="mt-4 pt-4 border-t border-black/10 flex justify-between items-end">
              <span className="font-serif italic text-gray-600 text-lg">
                Estimated Total
              </span>
              <span className="font-serif text-2xl text-soft-black text-right flex flex-col items-end">
                {hasEstimate && (
                  <span className="text-[10px] font-sans text-gray-500 tracking-widest uppercase mb-1 leading-none">
                    Starting at
                  </span>
                )}
                <span>
            ...
            <p className="font-sans text-[9px] text-gray-400 tracking-wider uppercase mt-4 text-center leading-relaxed">
              Final price will be decided after shipping
              <br />
              or additional bespoke framing requests.
            </p>
          </div>
        </div>
      </div>
