...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "array",
      description:
        'Select Style, Subject, or Collection tags (e.g. "Abstract", "Mountain", "Summer Sale")',
    ...
    defineField({
      ...
      type: "string",
      description:
        'Display text like "Oil on Canvas" (Use Categories for filtering)',
    ...
    defineField({
      ...
      type: "string",
      description:
        "Internal Stock Keeping Unit. This will NOT be visible on the website.",
    ...
    defineField({
      ...
      initialValue: false,
      description:
        'If toggled ON, the price will be visible to customers. If OFF, "Price on Request" will be implied.',
    }),
    defineField({
      name: "status",
    ...
    defineField({
      ...
      initialValue: false,
      description:
        "Toggle this ON to display this artwork in the curated collection section on the homepage.",
    }),
    ...
    defineField({
      ...
      type: "string",
      description:
        'e.g. "Gallery Vault", "The Ritz-Carlton Exhibition", "Private Collector"',
    ...
    defineField({
      ...
      type: "string",
      description:
        "Force the layout to treat this as Landscape (width-bound) or Portrait (height-bound). Leave empty for auto-detection.",
      options: {
        list: [
    ...
    defineField({
      ...
      of: [{ type: "block" }],
      description:
        "The Soul: Describe the Subject (Deity/Scene), Symbolism (Key details), and Technique (Materials/Craft).",
    }),
    defineField({
      name: "provenance",
      title: "Provenance",
      ...
      of: [{ type: "block" }],
      description:
        "The History: Trace the Origin (Where/When), Lineage (Artist Heritage), and Journey (Exhibitions/Collections).",
    }),
  ],
});
