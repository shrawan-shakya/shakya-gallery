  ...
  return (
    <footer className="bg-soft-black text-bone pt-24 pb-12 px-6 md:px-12 border-t border-white/10">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            {status === "success" ? (
              <div className="space-y-2">
                <p className="font-sans text-xs tracking-widest text-green-400 uppercase">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-4 max-w-sm">
                ...
                <div className="relative border-b border-white/20 focus-within:border-white transition-colors duration-300">
                  ...
                  <button 
                    type="submit" 
                    disabled={status === "submitting"}
                    className="absolute right-0 top-1/2 -translate-y-1/2 font-sans text-[10px] tracking-[0.2em] uppercase text-gray-400 hover:text-white transition-colors disabled:opacity-50"
                  >
            ...
            {status !== "success" && (
              <p className="font-sans text-[10px] text-gray-600 leading-relaxed">
        ...
        <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="space-y-8">
            <h4 className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase">Explore</h4>
          ...
          {/* Column B: Services */}
          <div className="space-y-8">
            <h4 className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase">Services</h4>
            <ul className="space-y-4">
           ...
           <div className="space-y-8">
            <h4 className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase">Connect</h4>
            <ul className="space-y-4">
              <li>
      ...
      <div className="max-w-[1400px] mx-auto mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="font-sans text-[10px] tracking-[0.2em] text-gray-600 uppercase">
          © {new Date().getFullYear()} Shakya Gallery. All Rights Reserved.
        </p>
        <div className="flex gap-8">
          <Link href="/privacy" className="font-sans text-[10px] tracking-[0.2em] text-gray-600 uppercase hover:text-white transition-colors">Privacy</Link>
          <Link href="/terms" className="font-sans text-[10px] tracking-[0.2em] text-gray-600 uppercase hover:text-white transition-colors">Terms</Link>
        </div>
      </div>
