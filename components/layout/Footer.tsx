        ...
        <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4">
              {["Collection", "Legacy", "Exhibitions", "Viewing Rooms"].map((item) => (
                <li key={item}>
                  <Link
                    href={item === "Collection" ? "/collection" : item === "Legacy" ? "/legacy" : "/coming-soon"}
                    className={cn(
                      "font-serif text-lg transition-all hover:italic",
                      (item === "Exhibitions" || item === "Viewing Rooms") ? "text-white/40 hover:text-white" : "text-white/80 hover:text-white"
                    )}
                  >
                    {item}
                  </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 lg:grid-cols-4 gap-x-12 lg:gap-x-16 gap-y-10 md:gap-y-16">
            <div className="flex flex-col items-start text-left gap-5">
              <ShieldCheck className="w-6 h-6 text-white/40 shrink-0 -ml-0.5" strokeWidth={1} />
              <div className="space-y-2">
                <h5 className="font-serif text-sm italic text-white/90 leading-none">Authenticity</h5>
                <p className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase leading-relaxed">Signed Certificates</p>
              </div>
            </div>
            <div className="flex flex-col items-start text-left gap-5">
              <Truck className="w-6 h-6 text-white/40 shrink-0 -ml-0.5" strokeWidth={1} />
              <div className="space-y-2">
                <h5 className="font-serif text-sm italic text-white/90 leading-none">Logistics</h5>
                <p className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase leading-relaxed">Insured Delivery</p>
              </div>
            </div>
            <div className="flex flex-col items-start text-left gap-5">
              <Lock className="w-6 h-6 text-white/40 shrink-0 -ml-0.5" strokeWidth={1} />
              <div className="space-y-2">
                <h5 className="font-serif text-sm italic text-white/90 leading-none">Payments</h5>
                <p className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase leading-relaxed">Secure Transfers</p>
              </div>
            </div>
            <div className="flex flex-col items-start text-left gap-5">
              <Award className="w-6 h-6 text-white/40 shrink-0 -ml-0.5" strokeWidth={1} />
              <div className="space-y-2">
                <h5 className="font-serif text-sm italic text-white/90 leading-none">Legacy</h5>
                <p className="font-sans text-[10px] tracking-[0.2em] text-gray-500 uppercase leading-relaxed">Since 1998</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 lg:border-l lg:border-white/5 lg:pl-16 flex flex-col justify-center gap-10 mt-12 lg:mt-0 pt-10 lg:pt-0 border-t border-white/5 lg:border-t-0">
            <div className="space-y-4">
              <span className="font-sans text-[9px] tracking-[0.3em] uppercase text-gray-500 block leading-none">International</span>
              <p className="font-serif text-white/80 italic text-base lg:text-lg leading-tight lg:mt-1">Wise, Payoneer, SWIFT Transfer</p>
            </div>
            <div className="space-y-4">
              <span className="font-sans text-[9px] tracking-[0.3em] uppercase text-gray-500 block leading-none">Local (Nepal)</span>
              <p className="font-serif text-white/80 italic text-base lg:text-lg leading-tight lg:mt-1">eSewa, Khalti, Bank Transfer, COD</p>
            </div>
          </div>
        </div>
      </div>
