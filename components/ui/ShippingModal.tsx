...
export function ShippingModal({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:px-6 md:pt-0">
          {/* Backdrop */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            className="relative w-full max-w-xl bg-bone shadow-2xl border border-white/20 max-h-[90vh] md:max-h-[85vh] my-4 md:mt-20 flex flex-col rounded-sm overflow-hidden"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            >
              <h3 className="font-serif text-2xl md:text-3xl text-soft-black mb-8 leading-tight">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  <label className="font-sans text-[11px] tracking-[0.2em] uppercase text-gray-800">
                    Destination
                  </label>
                  <div className="relative">
                    ...
                    <span className="absolute right-0 top-1/2 -translate-y-1/2 text-[10px] text-gray-800 pointer-events-none">
                      ▼
                    </span>
                  </div>
                </div>
                  ...
                  {estimate && (
                    ...
                    >
                      <div className="space-y-1">
                        <p className="font-sans text-[11px] tracking-[0.3em] uppercase text-gray-800">
                      ...
                      {zone === "ktm" ? (
                        <p className="font-sans text-[11px] text-gray-800 uppercase tracking-wider">
                          Complimentary doorstep delivery within the Valley{" "}
                          <br /> or visit our Kathmandu Gallery for pickup.
                        </p>
                      ) : (
                      ...
                      {zone !== "ktm" && (
                        <div className="pt-4 border-t border-black/5 mt-4 flex items-center justify-center gap-2">
                          ...
                          <span className="font-sans text-[9px] text-gray-800 uppercase tracking-widest">
                            Buyer is responsible for all local customs and
                            import taxes
                          </span>
                        </div>
                      )}
                ...
                <div className="space-y-4">
                  ...
                  <p className="font-sans text-[9px] text-center text-gray-800 tracking-wider uppercase">
                    This is an estimate only. Final quote within 24 business
                    hours.
                    {(!price || price < 1500) && (
                      <span className="block mt-2 text-frame-gold italic">
                        Complimentary shipping on all acquisitions over{" "}
                        {formatPrice(1500)}
                      </span>
                    )}
                  </p>
