...
export function MuseumFrame({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex-1 flex flex-col p-[6px] md:p-[22px]
      ...
      >
        ...
        >
          ...
          <div className={cn(
            ...
            hasMat ? "bg-[#FCFCFC] p-[6px] md:p-[20px] shadow-[inset_0_0_15px_rgba(0,0,0,0.4)]" : "bg-transparent p-0"
          )}>
