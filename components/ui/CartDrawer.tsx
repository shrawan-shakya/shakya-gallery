      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full max-w-md bg-bone z-[310] shadow-2xl flex flex-col"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-black/10">
              <h2 className="font-serif text-2xl text-soft-black">
                Your Inquiry Selection
              </h2>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center space-y-4 opacity-50">
                  ...
                  <button
                    onClick={onClose}
                    className="font-sans text-xs tracking-widest uppercase border-b border-black pb-1"
                  >
                    Continue Browsing
                  </button>
                </div>
                ...
                items.map((item, idx) => (
                  <div
                    ...
                    className="flex gap-4 items-start pb-6 border-b border-black/5 last:border-0"
                  >
                    {/* Image Thumbnail */}
            ...
            {items.length > 0 && (
              <div className="p-6 bg-white border-t border-black/10">
                ...
                <p className="font-sans text-[10px] text-gray-500 mb-4 text-center leading-relaxed">
                  Submit this selection to receive a unified shipping quote and
                  finalize your order.
                </p>
                <Link
                  href="/checkout"
