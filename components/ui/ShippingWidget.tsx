    ...
    <div className="bg-white border border-black/5 p-6 md:p-10 shadow-sm rounded-sm space-y-8 md:space-y-10">
      ...
      <div className="space-y-8">
          ...
          {estimate && (
            ...
            >
              <div className="space-y-1">
                <p className="font-sans text-[11px] tracking-[0.3em] uppercase text-gray-400">
              ...
              {zone === "ktm" ? (
                <p className="font-sans text-[11px] text-gray-500 uppercase tracking-wider leading-relaxed">
                  Complimentary doorstep delivery within the Valley <br /> or
                  visit our Kathmandu Gallery for pickup.
                </p>
              ) : (
                <>
                  ...
                  <div className="pt-4 border-t border-black/5 flex items-center justify-center gap-2">
                    ...
                    <span className="font-sans text-[9px] text-gray-500 uppercase tracking-widest">
                      Buyer is responsible for all local customs and import
                      taxes
                    </span>
                  </div>
                </>
        ...
        <p className="font-sans text-[9px] text-center text-gray-400 tracking-wider uppercase leading-relaxed">
          Estimate only. For oversized pieces or white-glove requests, please
