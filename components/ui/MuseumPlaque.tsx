  ...
  return (
    <div 
      className={cn(
        ...
        // UPDATED: 
        // 1. max-w-[280px] -> max-w-[380px] (Makes it physically wider)
        // 2. p-6 -> px-10 py-8 (More side padding stretches it horizontally)
        "px-10 py-8 w-full max-w-[380px]", 
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-2.5">
        ...
        {/* Artist */}
        <h3 className="font-sans text-[9px] tracking-[0.45em] uppercase text-[#999999] font-semibold whitespace-nowrap">
          {artist}
        </h3>

        {/* Title */}
        <h1 className="font-serif text-2xl text-[#1A1A1A] font-bold italic leading-none my-1">
          {title}
        </h1>

        {/* Medium */}
        <p className="font-sans text-[9px] tracking-[0.2em] uppercase text-[#666666] font-light">
          {medium}
        </p>

        {/* Separator */}
        <div className="w-[40px] h-[0.5px] bg-[#CCCCCC] my-1" />
        ...
        {/* Button */}
        {showButton && (
          <button className="mt-3 px-6 py-2.5 border border-[#1A1A1A]/10 hover:border-[#003153] hover:text-[#003153] transition-all duration-500 bg-transparent group/btn w-full">
            <span className="font-sans text-[8px] tracking-[0.3em] uppercase text-[#1A1A1A] group-hover/btn:text-[#003153] transition-colors">
              Private Inquiry
            </span>
          </button>
        )}
