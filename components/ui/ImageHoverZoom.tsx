...
export function ImageHoverZoom({
    ...
    return (
        <div
            ref={containerRef}
            className={cn("relative overflow-hidden cursor-crosshair group/zoom w-full h-full", className)}
        ...
        >
            ...
            <Image
                ...
                alt={alt}
                fill
                className={cn("object-cover transition-opacity duration-300", isHovered ? "opacity-0" : "opacity-100", imageClassName)}
                priority={priority}
                sizes={sizes}
            />
