...
>(({ className, style, ...props }, ref) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        "absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none",
        className,
      )}
...
>(({ className, style, ...props }, ref) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        "absolute inset-0 z-30 flex flex-col items-center justify-end pointer-events-none",
        className,
      )}
      style={{ opacity, ...style }}
      {...props}
