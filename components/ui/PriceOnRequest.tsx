    ...
    <div
      className={cn(
        ...
        variant === "badge" || variant === "minimal"
          ...
          : "flex-wrap items-baseline gap-x-2 gap-y-1",
        className,
      )}
    >
      <span
        className={cn(
          ...
          variant === "minimal" &&
            "text-[9px] md:text-[11px] text-soft-black/70",
          variant === "plaque" && "text-[10px] md:text-[12px]",
          variant === "detail" &&
            "text-[9.5px] sm:text-[11px] md:text-sm tracking-[0.05em] sm:tracking-[0.1em] md:tracking-[0.15em]",
          variant === "badge" &&
            "text-[11px] md:text-[14px] tracking-widest text-soft-black/70",
        )}
      >
        {variant !== "badge" && variant !== "minimal" && (
          <>
