              ...
              {results.length > 0 ? (
                          ...
                          <div className="flex items-center gap-3 mt-1">
                            ...
                            {art.status === "available" &&
                              ...
                              art.price && (
                                <Price
                                  amount={art.price}
                                  className="text-xs text-soft-black/60 font-sans"
                                />
                              )}
                            {art.status === "available" &&
                              !art.showPrice &&
                ...
                query.length < 2 && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-12 opacity-50">
                    <div>
                      <h4 className="font-serif text-xl mb-4 text-soft-black">
                        Trending
                      </h4>
                      <ul className="space-y-2">
                        <li className="text-sm uppercase tracking-widest cursor-pointer hover:text-soft-black/70">
                          Abstract
                        </li>
                        <li className="text-sm uppercase tracking-widest cursor-pointer hover:text-soft-black/70">
                          Landscapes
