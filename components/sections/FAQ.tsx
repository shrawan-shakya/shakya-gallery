    ...
    <section className="bg-bone py-24 px-6 border-t border-black/5">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          <p className="font-sans text-[10px] md:text-xs tracking-[0.3em] text-gray-800 uppercase mb-4">
            Common Questions
          </p>
          <h2 className="font-serif text-3xl md:text-4xl text-soft-black">
            Collector's <span className="italic">Guide</span>
          </h2>
        </div>
