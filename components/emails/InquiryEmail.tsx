        ...
        <Container style={container}>
          ...
          <Section style={section}>
            ...
            <Row style={row}>
              ...
              <Column style={columnRight}>
                <Text style={value}>{inquirerMobile}</Text>
              </Column>
            </Row>
          </Section>
          ...
          <Section style={section}>
            ...
            <Text style={addressText}>
              <pre style={pre}>{shippingAddress}</pre>
            </Text>
          </Section>
          ...
          <Section style={section}>
            <Heading as="h2" style={h2}>
              Inquiry Selection ({cartItems.length})
            </Heading>
          ...
          <Section style={totalsSection}>
            ...
            <Text style={totalsNote}>
              * Shipping and bespoke framing costs not included.
            </Text>
          </Section>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              Automated notification from Shakya Gallery Website.
              <br />
